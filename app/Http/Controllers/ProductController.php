...
class ProductController extends Controller
{
    public function index(Request $request)
    {
        ...
        $priceBuckets = [
            ['key' => 'lt10', 'label' => 'Moins de 10 000 DA', 'min' => null, 'max' => 9999],
            ['key' => '10-15', 'label' => '10 000 – 15 000 DA', 'min' => 10000, 'max' => 15000],
            ['key' => '15-20', 'label' => '15 000 – 20 000 DA', 'min' => 15000, 'max' => 20000],
            ['key' => 'gt20', 'label' => 'Plus de 20 000 DA', 'min' => 20001, 'max' => null],
        ];
        ...
        $products = Product::with([
            ...
            ->when(! $request->sort || $request->sort === 'newest', fn ($query) => $query->latest())
            ->paginate(12)
            ->withQueryString();

        return view('shop.index', compact('products', 'categories', 'sizes', 'colors', 'priceBuckets'));
    }
