        ...
        >
            ...
            <div class="search-input-box">
                ...
                <input
                    ...
                    placeholder="RECHERCHE CANDIDAT, EMAIL..."
                        ...
                        <td>
                            ...
                            <div class="candidate-identity-stack">
                                ...
                                <span class="candidate-fullname">
                                    ...
                                    {{ strtoupper($candidate->user->name ?? 'CANDIDAT') }}
                        ...
                        <td>
                            ...
                            <div class="product-target-stack">
                                ...
                                <span class="product-name">
                                    ...
                                    {{ $candidate->drop->products->first()->name ?? '—' }}
                            ...
                            <div class="decision-actions-row">
                                ...
                                @if($candidate->status !== 'approved' && Route::has('admin.drops.whitelist.approve'))
                                    ...
                                    <form
                                        ...
                                        action="{{ route('admin.drops.whitelist.approve', [$candidate->drop, $candidate->id]) }}"
                                ...
                                @if($candidate->status !== 'rejected' && Route::has('admin.drops.whitelist.reject'))
                                    ...
                                    <form
                                        ...
                                        action="{{ route('admin.drops.whitelist.reject', [$candidate->drop, $candidate->id]) }}"
