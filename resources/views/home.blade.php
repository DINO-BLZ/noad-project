    ...
    <div class="reset-visual-col">
        ...
        <div class="visual-bottom-card">
            ...
            <blockquote class="card-quote">
                « LA SÉCURITÉ DE VOTRE ACCÈS GARANTIT L'INTÉGRITÉ DE
                VOS RÉSERVATIONS DROPS ET DE VOTRE HISTORIQUE WHITELIST. »
            </blockquote>
    ...
    <div class="reset-form-col">
        ...
        <div class="reset-form-inner">
            ...
            >
                ...
                {{-- Token de réinitialisation Laravel --}}
                <input
                    type="hidden"
                    name="token"
